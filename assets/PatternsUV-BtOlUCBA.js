...
}`,_=a(),v=new t(10,10,1,1);function y(){let{scene:t,camera:a,size:o}=s(),{material:c,uniforms:f}=(0,m.useMemo)(()=>{let e={uPattern:{value:1},uVars:{value:new i(0,0,0,0)},uTime:{value:0},uResolution:{value:new p(1,1)}};return{material:new r({vertexShader:h,fragmentShader:g,wireframe:!1,side:2,transparent:!1,uniforms:e}),uniforms:e}},[]);return(0,m.useEffect)(()=>{let e=new d({title:`Shader Patterns UV`});e.addBinding(f.uPattern,`value`,{label:`Pattern`,min:1,max:40,step:1});let t=e.addFolder({title:`Vars`});return t.addBinding(f.uVars.value,`x`,{label:`X`,min:0,max:1,step:.01}),t.addBinding(f.uVars.value,`y`,{label:`Y`,min:0,max:1,step:.01}),t.addBinding(f.uVars.value,`z`,{label:`Z`,min:0,max:1,step:.01}),t.addBinding(f.uVars.value,`w`,{label:`W`,min:0,max:1,step:.01}),()=>{e.dispose()}},[f]),(0,m.useEffect)(()=>{f.uResolution.value.set(o.width,o.height)},[o,f]),(0,m.useEffect)(()=>(t.background=new e(0),()=>{t.background=null}),[t]),(0,m.useEffect)(()=>{a.position.set(0,0,9),a.rotation.set(0,0,0),a instanceof n&&(a.zoom=65,a.updateProjectionMatrix())},[a]),u(({clock:e})=>{f.uTime.value=e.elapsedTime}),(0,m.useEffect)(()=>()=>{c.dispose()},[c]),(0,_.jsx)(l,{useCameraControls:!1,unselectableChildren:(0,_.jsx)(`mesh`,{position:[0,0,0],name:`mesh`,geometry:v,material:c})})}function b(){return(0,_.jsx)(f,{orthographic:!0,cameraProps:{zoom:55},children:(0,_.jsx)(y,{})})}export{b as default};