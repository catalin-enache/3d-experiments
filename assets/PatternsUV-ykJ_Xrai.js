...
}`,_=i(),v=new t(10,10,1,1);function y(){let{scene:t,camera:i,size:o}=a(),{material:u,uniforms:p}=(0,m.useMemo)(()=>{let e={uPattern:{value:1},uVars:{value:new r(0,0,0,0)},uTime:{value:0},uResolution:{value:new l(1,1)}};return{material:new n({vertexShader:h,fragmentShader:g,wireframe:!1,side:2,transparent:!1,uniforms:e}),uniforms:e}},[]);return(0,m.useEffect)(()=>{let e=new f({title:`Shader Patterns UV`});e.addBinding(p.uPattern,`value`,{label:`Pattern`,min:1,max:40,step:1});let t=e.addFolder({title:`Vars`});return t.addBinding(p.uVars.value,`x`,{label:`X`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`y`,{label:`Y`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`z`,{label:`Z`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`w`,{label:`W`,min:0,max:1,step:.01}),()=>{e.dispose()}},[p]),(0,m.useEffect)(()=>{p.uResolution.value.set(o.width,o.height)},[o,p]),(0,m.useEffect)(()=>(t.background=new e(0),()=>{t.background=null}),[t]),(0,m.useEffect)(()=>{i.position.set(0,0,9),i.rotation.set(0,0,0),i instanceof c&&(i.zoom=65,i.updateProjectionMatrix())},[i]),d(({clock:e})=>{p.uTime.value=e.elapsedTime}),(0,m.useEffect)(()=>()=>{u.dispose()},[u]),(0,_.jsx)(s,{useCameraControls:!1,unselectableChildren:(0,_.jsx)(`mesh`,{position:[0,0,0],name:`mesh`,geometry:v,material:u})})}function b(){return(0,_.jsx)(p,{orthographic:!0,cameraProps:{zoom:55},children:(0,_.jsx)(y,{})})}export{b as default};