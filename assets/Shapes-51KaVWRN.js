import{Wt as e,a as t,an as n,cn as r,kt as i,ln as a,m as o,r as s}from"./index-CzKUGHpr.js";import{t as c}from"./lil-gui.esm-BsdZdNnU.js";var l=a(r(),1),u=`varying vec2 vUv;
...
void main() {
    ...
    gl_FragColor = vec4(color, 1.0);
}`,f=o(),p=new i(10,10,1,1),m={uShape:{value:1},uVars:{value:new n(0,0,0,0)}},h=new e({vertexShader:u,fragmentShader:d,wireframe:!1,side:2,transparent:!1,uniforms:m});function g(){return(0,l.useEffect)(()=>{let e=new c,t={shape:m.uShape.value,vars:{x:m.uVars.value.x,y:m.uVars.value.y,z:m.uVars.value.z,w:m.uVars.value.w}};e.add(t,`shape`,1,30,1).name(`Shape`).onChange(e=>{m.uShape.value=e});let n=e.addFolder(`Vars`);return n.add(t.vars,`x`,0,1,.01).name(`X`).onChange(e=>{m.uVars.value.x=e}),n.add(t.vars,`y`,0,1,.01).name(`Y`).onChange(e=>{m.uVars.value.y=e}),n.add(t.vars,`z`,0,1,.01).name(`Z`).onChange(e=>{m.uVars.value.z=e}),n.add(t.vars,`w`,0,1,.01).name(`W`).onChange(e=>{m.uVars.value.w=e}),()=>{e.destroy()}},[]),(0,f.jsx)(s,{useCameraControls:!1,useTransformControls:!1,unselectableChildren:(0,f.jsx)(`mesh`,{position:[0,0,0],name:`mesh`,geometry:p,material:h})})}function _(){return(0,f.jsx)(t,{orthographic:!0,cameraProps:{zoom:55},children:(0,f.jsx)(g,{})})}export{_ as default};