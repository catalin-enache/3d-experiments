import{Dt as e,Ht as t,T as n,a as r,d as i,m as a,n as o,on as s,p as c,r as l,rn as u,sn as d,tn as f,wt as p}from"./index-CKS4Xxgm.js";var m=d(s(),1),h=`uniform vec2 uResolution;
...
}`,_=a(),v=new e(10,10,1,1);function y(){let{scene:e,camera:r,size:a}=c(),{material:s,uniforms:d}=(0,m.useMemo)(()=>{let e={uPattern:{value:1},uVars:{value:new u(0,0,0,0)},uTime:{value:0},uResolution:{value:new f(1,1)}};return{material:new t({vertexShader:h,fragmentShader:g,wireframe:!1,side:2,transparent:!1,uniforms:e}),uniforms:e}},[]);return(0,m.useEffect)(()=>{let e=new o({title:`Shader Patterns UV`});e.addBinding(d.uPattern,`value`,{label:`Pattern`,min:1,max:40,step:1});let t=e.addFolder({title:`Vars`});return t.addBinding(d.uVars.value,`x`,{label:`X`,min:0,max:1,step:.01}),t.addBinding(d.uVars.value,`y`,{label:`Y`,min:0,max:1,step:.01}),t.addBinding(d.uVars.value,`z`,{label:`Z`,min:0,max:1,step:.01}),t.addBinding(d.uVars.value,`w`,{label:`W`,min:0,max:1,step:.01}),()=>{e.dispose()}},[d]),(0,m.useEffect)(()=>{d.uResolution.value.set(a.width,a.height)},[a,d]),(0,m.useEffect)(()=>(e.background=new n(0),()=>{e.background=null}),[e]),(0,m.useEffect)(()=>{r.position.set(0,0,9),r.rotation.set(0,0,0),r instanceof p&&(r.zoom=65,r.updateProjectionMatrix())},[r]),i(({clock:e})=>{d.uTime.value=e.elapsedTime}),(0,m.useEffect)(()=>()=>{s.dispose()},[s]),(0,_.jsx)(l,{useCameraControls:!1,unselectableChildren:(0,_.jsx)(`mesh`,{position:[0,0,0],name:`mesh`,geometry:v,material:s})})}function b(){return(0,_.jsx)(r,{orthographic:!0,cameraProps:{zoom:55},children:(0,_.jsx)(y,{})})}export{b as default};