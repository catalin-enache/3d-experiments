import{D as e,Kt as t,Ot as n,an as r,dn as i,g as a,h as o,i as s,jt as c,p as l,r as u,s as d,sn as f,un as p}from"./index-CjXavWdB.js";var m=i(p(),1),h=`uniform vec2 uResolution;
...
}`,_=a(),v=new c(10,10,1,1);function y(){let{scene:i,camera:a,size:c}=o(),{material:d,uniforms:p}=(0,m.useMemo)(()=>{let e={uPattern:{value:1},uVars:{value:new f(0,0,0,0)},uTime:{value:0},uResolution:{value:new r(1,1)}};return{material:new t({vertexShader:h,fragmentShader:g,wireframe:!1,side:2,transparent:!1,uniforms:e}),uniforms:e}},[]);return(0,m.useEffect)(()=>{let e=new u({title:`Shader Patterns UV`});e.addBinding(p.uPattern,`value`,{label:`Pattern`,min:1,max:40,step:1});let t=e.addFolder({title:`Vars`});return t.addBinding(p.uVars.value,`x`,{label:`X`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`y`,{label:`Y`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`z`,{label:`Z`,min:0,max:1,step:.01}),t.addBinding(p.uVars.value,`w`,{label:`W`,min:0,max:1,step:.01}),()=>{e.dispose()}},[p]),(0,m.useEffect)(()=>{p.uResolution.value.set(c.width,c.height)},[c,p]),(0,m.useEffect)(()=>(i.background=new e(0),()=>{i.background=null}),[i]),(0,m.useEffect)(()=>{a.position.set(0,0,9),a.rotation.set(0,0,0),a instanceof n&&(a.zoom=65,a.updateProjectionMatrix())},[a]),l(({clock:e})=>{p.uTime.value=e.elapsedTime}),(0,m.useEffect)(()=>()=>{d.dispose()},[d]),(0,_.jsx)(s,{useCameraControls:!1,unselectableChildren:(0,_.jsx)(`mesh`,{position:[0,0,0],name:`mesh`,geometry:v,material:d})})}function b(){return(0,_.jsx)(d,{orthographic:!0,cameraProps:{zoom:55},children:(0,_.jsx)(y,{})})}export{b as default};